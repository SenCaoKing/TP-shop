...
<!--引入公共的jquery-->
        ...
        <div class="header w990 bc mt15">
            <div class="logo w990">
                <h2 class="fl"><a href="<?php echo U('Index/index');?>"><img src="<?php echo (C("IMG_URL")); ?>logo.png" alt="京西商城"></a></h2>
...
<div class="mycart w990 mt10 bc">
	...
	<table>
		...
		<tbody>
			...
			<script type="text/javascript">
				//购物车商品数量变化【购物车数量变化过程递增-递减-modify_num(集成)】
				//参数:flag=add/reduce/mod
				function modify_num(goods_id,flag){
					//获得商品目前的数量
					var now_num = parseInt($('#goods_number_'+goods_id).val());//parseInt() 函数可解析一个字符串，并返回一个整数
					if(flag == 'add'){
	...
	<div class="cart_btn w990 bc mt10">
		...
		<a href="<?php echo U('Shop/showorder');?>" class="checkout">结 算</a>
	</div>
</div>
<!-- 主体部分 end -->
