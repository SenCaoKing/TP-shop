...
<!--引入公共的jquery-->
        ...
        <div class="header w1210 bc mt15">
            ...
            <div class="logo w1210">
                <h1 class="fl"><a href="<?php echo U('Index/index');?>"><img src="<?php echo (C("IMG_URL")); ?>logo.png" alt="京西商城"></a></h1>
                <!-- 头部搜索 start -->
                <div class="search fl">
                                    ...
                                    <?php if(is_array($cat_infoA)): foreach($cat_infoA as $key=>$v): ?><div class="cat item1">
                                            ...
                                            <div class="cat_detail">
                                                <?php if(is_array($cat_infoB)): foreach($cat_infoB as $key=>$vv): if(($vv['cat_pid']) == $v['cat_id']): ?><dl class="dl_1st">
                                                            ...
                                                            <?php if(is_array($cat_infoC)): foreach($cat_infoC as $key=>$vvv): if(($vvv['cat_pid']) == $vv['cat_id']): ?><dd>
                                                                        <a href="<?php echo U('Goods/showlist',array('cat_id'=>$vvv['cat_id']));?>"><?php echo ($vvv["cat_name"]); ?></a>
...
<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo (C("SITE_URL")); echo ($vvv["pics_mid"]); ?>',largeimage: '<?php echo (C("SITE_URL")); echo ($vvv["pics_big"]); ?>'}">
									<?php else: ?> 
										<li>
<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo (C("SITE_URL")); echo ($vvv["pics_mid"]); ?>',largeimage: '<?php echo (C("SITE_URL")); echo ($vvv["pics_big"]); ?>'}"><?php endif; ?>	
			...
			<div class="goodsinfo fl ml10">
				<ul>
					...
					<li><span>上架时间：</span><?php echo (date("Y-m-d H:i:s",$info["add_time"])); ?></li><!--注意不要有空格-->
					...
					<ul>
						<?php if(is_array($attrinfoT)): foreach($attrinfoT as $key=>$v): ?><li class="product">
								<dl>
									...
									<dd>
										<?php if(is_array($v['attr_value'])): foreach($v['attr_value'] as $kk=>$vv): if(($kk) == "0"): ?><a class='selected' href="javascript:;">
										<?php else: ?>
...
<p>
	<a href="<?php echo U('Shop/showlist');?>" onclick="javascript:$('#cartBox').hide()" class="bt_orange" target="_blank"></a>
